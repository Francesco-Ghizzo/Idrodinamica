...
iF = ... # Pendenza costante del canale [-]
L = ... # Lunghezza del canale [m]
IMAX = ... # Numero di celle del dominio [-]
NMAX = ... # Numero massimo di iterazioni temporali [-]
ks = ... # Coefficiente di scabrezza del fondo [m^(1/3)/s]
...
def CC( t, dt, U, problema ):
    ...
    if problema == 'diga':
        Y[0], q[0] = ... # Condizioni di monte
        Y[-1], q[-1] = ... # Condizioni di valle
