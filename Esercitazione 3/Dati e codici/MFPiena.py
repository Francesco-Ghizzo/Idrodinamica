...
problema = 'piena' # Opzioni: 'diga', 'piena'
...
NMAX =10000# Numero massimo di iterazioni temporali [-]
...
xdiga = 20 # Posizione dello sbarramento [m]
...
if problema == 'piena':
    ...
    # Cappio di piena
    dist=[10001, 20002, 30003, 40004, 50005]  #[10km, 20km, 30km,40km, 50km]
