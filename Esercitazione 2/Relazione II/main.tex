...
I dati ricavati dalle varie esperienze sono stati plottati tramite Excel per ottenere un confronto grafico della variazione di posizione del risalto al variare della scabrezza del fondo centrale (Figura \ref{fig:risalto_FTF}):
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{Profilo HEC-RAS FTF.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{Profilo HEC-RAS TTT.png}
...
In questa fase viene inserita inserisce anche la geometria del ponte, ricreandone le pile e le campate nella maniera più fedele. La struttura ha larghezza pari a 8 m ed è collocata a 190 m dalla confluenza con il torrente Lavagna.
